...
abstract class IllytestModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<IllytestModDependenciesExtension>("illytestModDependencies")
