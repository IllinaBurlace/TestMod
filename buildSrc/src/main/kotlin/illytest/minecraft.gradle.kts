...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/illytest.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: illytest-common-common-refmap.json
        // fixed:   illytest-common.refmap.json
